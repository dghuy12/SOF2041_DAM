...
public class ChaoJDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/edusys/icon/EduSys - icon.png"))); // NOI18N
    ...
    private void init() {
        ...
        ChaoJDialog that = this;
        new Timer(10, new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                int value = that.pgbLoading.getValue();
                if (value < that.pgbLoading.getMaximum()) {
                    that.pgbLoading.setValue(value + 1);
                } else {
